...
export const translations: Record<'zh' | 'en', TranslationTexts> = {
  zh: {
    ...
    basicInfoPhase: "基本信息阶段",
    extendedInfoPhase: "扩展信息阶段",
    submittedPhase: "已提交",
    orderSubmitted: "订单已提交",
    submittingOrder: "正在提交...",
    generateInternalCodes: "生成内部编号",
    generatingCodes: "正在生成编号...",
    viewSubmittedOrder: "查看已提交订单",
    resubmitOrder: "重新提交",
  ...
  en: {
    ...
    basicInfoPhase: "Basic Information Phase",
    extendedInfoPhase: "Extended Information Phase",
    submittedPhase: "Submitted",
    orderSubmitted: "Order Submitted",
    submittingOrder: "Submitting...",
    generateInternalCodes: "Generate Internal Codes",
    generatingCodes: "Generating Codes...",
    viewSubmittedOrder: "View Submitted Order",
